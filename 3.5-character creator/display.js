...
//All the skills in 3.5 edition and their corresponding parent value
...
//Assigns modifier values to the characters main 6 stats depending on size
//Lacks proper validation for a raw value over 18 *face palm emoji*
...
//Uses splice to delete character from myCharacter array
...
function handleDeleteClick(){
  ...
  localStorage.setItem('currentCharacter', JSON.stringify(currentCharacter));
  //Chucks user back to main screen after successful deletion
